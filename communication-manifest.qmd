...
::: callout-tip
There is a specific folder in the GitHub repository attached to this book where to find a wrap-up template with both parameters & return value : [wrapup-module](https://github.com/thekangaroofactory/template-r-shiny-communication/tree/main/wrapup-module)
:::
