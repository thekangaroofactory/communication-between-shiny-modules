...
Outputs are defined on the server side, then consumed on the ui side **at the same leve**l, then go up through the ui functions just as the inputs did[^communication-between-modules-9].
