...
The challenges are even more complex as modules are running in their own context where they only see their own inputs & outputs[^intro-2] - this is called namespace and the logic behind is explained here: [@masteringshinyChapterShiny]
